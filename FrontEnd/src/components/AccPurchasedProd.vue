<template>
                    <div>
                        ...
                        <h4 style="margin-top: 10px;"><i class="fab fa-product-hunt"></i> {{title}}</h4>
                        <h6 style="margin: auto;"><i class="fas fa-handshake"></i> {{name}}</h6>
                        <h6 style="margin: auto;"><i class="far fa-calendar-alt"></i>   {{date}}</h6>
                        <h6 style="margin: auto;"><i class="fas fa-tags"></i> {{price}} L.E</h6>
                    </div>
</template>

<script>
export default {
 name: 'AccPurchasedProd',
 props: ["img","title","price","name","date"]
}
</script>
