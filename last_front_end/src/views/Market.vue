        ...
        <div class="container">
            <div class="row">
                <div class="col" style="color: #33bfb4; margin-top: 10px; text-align: center;">
                    ...
                    <!-- <div class="row2"> -->
                 <purchasedComp  class="row2" v-for="co in MyProducts" :key="co.id" :img="co.img" :price="co.price" :title="co.title"/>
                    <hr>
                    <!-- </div> -->
                    <div class="row1" style="color: #33bfb4; font-size: 25px; margin-top: 20px;">
                        Other Users Products
                    </div>
              <SoldComp  class="row2" v-for="co in SoldProducts" :key="co.id" :img="co.img" :price="co.price" :title="co.title" :name="co.name"/>
                </div>
            </div>
        </div>
    </div>
...
import PurchasedComp from '../components/PurchasedComp.vue';
import SoldComp from '../components/SoldComp.vue';
export default {
...
return{
 ...
 components: {
  ...
  this.MyProducts = await (await axios.get('/api/market/getMyProducts/'+userid)).data;
  this.SoldProducts = await (await axios.get('/api/market/getOthersProduct/'+userid)).data;
