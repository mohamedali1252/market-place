...
<div>
 <div class="search-box">
            ...
            <input v-model="search_result" type="search" class="form-control"> <!-- Search Text Bar -->
             <button  @click="search_item()" class="input-group-text" style="text-decoration: none;"> <i class="fas fa-search"></i> </button>
        </div>
        <div>
             <searchcomp  class="row2" v-for="co in searches" :key="co.id" :img="co.img" :price="co.price" :title="co.title"/>
        </div>
</div>
</template>
<script>
...
this.searches = await (await axios.get('/api/products?name='+this.search_result)).data;
